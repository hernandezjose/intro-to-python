...
# Create a new Robot called stanford_karel at (4, 4), facing East with 0 Beepers
karel = Robot(4, 4, "East", 0)
bruh = BruhRobot(3, 3, "East", 0)
# Add stanford_karel to the World
world.add_robots(karel, bruh)

# Start the World
world.start()

# Have stanford_karel use our new methods, along with base methods, to interact with the World
karel.turn(2)
bruh.say_bruh()
karel.move_x(2)
karel.turn(-1)
